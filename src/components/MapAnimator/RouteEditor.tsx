    ...
    <div className="flex flex-col gap-6 text-[#403D39]">
      ...
      <div className="flex flex-col gap-1.5 -mt-2">
        <button
          ...
          className={`w-full py-3 px-4 rounded-xl font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed ${hasUncalculatedChanges
          ...
          {VEHICLE_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center p-2 rounded-xl border gap-1.5 transition-all ${isSelected
        ...
        <div className="mt-1">
          ...
          {routeConfig.customVehicleImage ? (
            <div
              ...
              className={`p-3 rounded-xl border transition-all cursor-pointer flex items-center justify-between gap-3 ${routeConfig.vehicle === 'custom'
              ...
              {(['walk', 'bicycle', 'car', 'bus', 'train', 'shinkansen', 'flight', 'ship'] as ModeCategory[]).map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center p-1.5 rounded-lg border text-[10px] font-medium transition-all ${isCatSelected
        ...
        <div className="flex flex-wrap gap-1.5">
          {['25 min', '40 min', '1h 15 min', '2h 30 min', '4h 45 min', '6 hrs'].map((time) => (
            <button
              ...
              className={`text-[11px] px-2.5 py-0.5 rounded-md border transition-all ${routeConfig.travelTimeText === time
